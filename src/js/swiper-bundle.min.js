...
function slideActive() {
  ...
  if (!!document.querySelector('.repair')) {
    const swiper = new Swiper('.repair', {
      // Optional parameters
      direction: 'horizontal',
      loop: true,
      spaceBetween: 15,
...
const element = document.querySelector('.list-btn__el')
const elments = document.querySelectorAll('.list-slide__el-show')
const text = document.querySelector('.list-btn__el-text')
const icon = document.querySelector('.list-btn__el-img')
console.log(element)
console.log(elments)

element.addEventListener('click', () => {
  if (text.textContent == 'Показать всё') {
    //elments.style.removeProperty('display')
    text.textContent = 'Скрыть'
    elments.forEach((el) => {
      el.classList.remove('list-slide__el-show')
      icon.classList.add('list-btn__el-img--rotate')
    })
  } else {
    text.textContent = 'Показать всё'
    icon.classList.remove('list-btn__el-img--rotate')
    elments.forEach((el) => {
      el.classList.add('list-slide__el-show')
    })
  }
})
...
const elementRepair = document.querySelector('.repair-btn__el')
const elmentsRepair = document.querySelectorAll('.repair-slide__el-show')
const textRepair = document.querySelector('.repair-btn__el-text')
const iconRepair = document.querySelector('.repair-btn__el-img')
console.log(elementRepair)
console.log(elmentsRepair)

elementRepair.addEventListener('click', () => {
  if (textRepair.textContent == 'Показать всё') {
    //elments.style.removeProperty('display')
    textRepair.textContent = 'Скрыть'
    elmentsRepair.forEach((el) => {
      el.classList.remove('repair-slide__el-show')
      iconRepair.classList.add('repair-btn__el-img--rotate')
    })
  } else {
    textRepair.textContent = 'Показать всё'
    iconRepair.classList.remove('repair-btn__el-img--rotate')
    elmentsRepair.forEach((el) => {
      el.classList.add('repair-slide__el-show')
    })
  }
})
